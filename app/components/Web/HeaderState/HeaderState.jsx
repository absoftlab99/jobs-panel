    ...
    return (
        <div>
            ...
            <div className="flex gap-5 py-5">
                <div className="cursor-pointer flex gap-3 border-2 rounded border-dotted border-primary p-3 bg-white hover:bg-green-100 transition-colors duration-500 w-[300px]">
